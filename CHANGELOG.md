...
* Add detections for `confstr`, `ttyname_r/ptsname_r`, `readlinkat`, `fgetws/fgetws_l`, `*cftime`, `chdir`, `chroot`, `inet_*`, `mbs/wcs`, and missing `get*` family functions (`interesting-api-calls`).
