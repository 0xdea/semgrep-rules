...
* Add some code samples (`command-injection`, `format-string-bugs`, `incorrect-use-of-sizeof`, `insecure-api-access-stat`, `use-of-source-size-in-copy`, `unterminated-string-strncpy`).
