...
* [**incorrect-use-of-strncpy-stpncpy-strlcpy**](rules/c/incorrect-use-of-strncpy-stpncpy-strlcpy.yaml). Wrong size argument passed to strncpy(), stpncpy(), strlcpy().
...
* Extensive testing of the current rules compared to v1.0.0, then release of v1.1.0.
...
* Add a script to clean up pseudocode generated by [common decompilers](https://github.com/0xdea/semgrep-rules/issues/12) to improve Semgrep parsing.
